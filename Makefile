...
SRC=main
CONTROLLER=atmega8
F_CPU=4000000 # 4MHz for accurate baudrate timing
programmerDev=/dev/ttyUSB003
programmerType=arduino

CFLAGS=-g -DF_CPU=$(F_CPU) -Wall -Os -Werror -Wextra
...
object:
	avr-gcc $(CFLAGS) -mmcu=$(CONTROLLER) -Wa,-ahlmns=$(SRC).lst -c -o $(SRC).o $(SRC).c
